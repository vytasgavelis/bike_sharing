...
urlpatterns = [
    ...
    path('parking-site/<int:id>/services', login_required(ParkingSiteServiceView.as_view()), name='parking_site_service_list'),
    ...
    path('site/<int:site_id>/parking_sessions/users/<int:user_id>/end', login_required(ParkingSessionEndView.as_view()), name='end_parking_session'),
