...
class SignupForm(UserCreationForm):
    ...
    def clean_phone_number(self) -> str:
        #TODO: check if number does not exist
        phone_number = self.cleaned_data['phone_number']
        if not re.match("^(86|\+3706)\d{7}$", phone_number):
            raise forms.ValidationError('Phone number format incorrect. Must start with 86 or +3706')
